...
{
    public partial class TopVehicleType : Form
    {
        public TopVehicleType()
        {
            InitializeComponent();
        }
        ...
        {
            return
                "select VehicleType.Vtype, count(*) as 'TransactionCount' " +
                "from [Booking], Branch, Vehicle, VehicleType " +
        ...
        private void searchSpecificButton_Click(object sender, EventArgs e)
        {
            ...
            General.validTextboxEntry(specificSearchErrorLabel, query, popularCarTypeDataGridView);
        }
